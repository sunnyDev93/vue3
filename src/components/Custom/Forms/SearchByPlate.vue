  ...
  <div class="vehicle-search">
    ...
    <div class="w-full flex flex-col md:flex-row flex-wrap gap-4 md:gap-0">
      ...
      <div class="w-full md:w-1/6">
        ...
        <p v-if="serieErr" class="text-red-500 text-sm">
          {{ serieErr }}
        </p>
      </div>
      <div class="w-full md:w-20">
        <div class="flex flex-wrap">
          <span
            class="inline-flex items-center rounded-md bg-gray-50 px-5 py-3 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10"
          >
            {{ plateType }}</span
          >
        </div>
      ...
      <div v-if="plateType === 'TU'" class="w-full md:w-1/6">
        ...
        <p v-if="plateErr" class="text-red-500 text-sm">
          {{ plateErr }}
        </p>
      </div>
    </div>
    <div>
      <ElButton class="btn" icon="search" @click="handleSearchByPlate">
        Search
      </ElButton>
    </div>
